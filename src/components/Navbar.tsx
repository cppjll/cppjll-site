    ...
    return (
        <div className='fixed z-10 top-0 w-screen bg-secondary-focus'>
            <div className='navbar md:max-w-4xl mx-auto bg-secondary-focus'>
                ...
                {/* The right of the navbar, has dropdown menu on mobile, text on desktop */}
                <div className='navbar-end'>
                    <ul className='hidden md:flex menu menu-horizontal px-2 text-accent'>
                        <li><a className="text-nv hover:text-green-100" href="/events">Events</a></li>
                        <li><a className="text-nv hover:text-green-100" href="/board">Board</a></li>
                    </ul>   
                    <details className='dropdown pr-3'>
